...
for (i in (1:dim(combis)[2])) {
 ...
 # browser()
  ...
  cghregions <- CGHregions(cghcallcombined, averror=0.025)
  ...
  filename_prefix_CGHtestOutput = sub("csv",  paste(combis[1,i], "_vs_",combis[2,i], ".CGHtest2.5", sep=""), filenameOfSelection, perl=TRUE)
...
#j = 1
  ...
  filenameOfCGHregionsOutput = sub("CGHtest2.5", "CGHregions2.5.tab", filename_prefix_CGHtestOutput, perl=TRUE)
